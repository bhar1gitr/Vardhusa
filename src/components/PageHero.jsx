...
export default function PageHero({ title, highlight, subtitle, img, minH = "min-h-[420px]" }) {
  return (
    <section className="container-wrap pt-6">
      <div className={`relative overflow-hidden ${minH} flex flex-col items-center justify-center text-center px-6`}>
        <div
